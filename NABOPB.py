...
def NABOPB(
    ...
    basis_flag : str
        ...
        - 'Fourier_SRLasso': Fourier basis on [0,1]^d with square root LASSO.
        - 'Fourier_OMP': Fourier basis on [0,1]^d with orthogonal matching pursuit.
        - 'Fourier_COSAMP': Fourier basis on [0,1]^d with COSAMP.
        ...
        - 'Cheby_SRLasso': Chebyshev basis on [-1,1]^d with square root LASSO.
        - 'Cheby_OMP': Chebyshev basis on [-1,1]^d with orthogonal matching pursuit.
        - 'Cheby_COSAMP': Chebyshev basis on [-1,1]^d with COSAMP.
...
def increment(
    J, fct_handle, d, gamma, basis_flag, sparsity_s, sparsity_s_local, delta, niter_r
):
    sample_sizes = 0
    cand_sizes = 0
    ...
    W, Xi = nabopb.construct_cubature(K, basis_flag, dims, d, sparsity_s_local)
